...
are enough to pretrain a 500M model. It provides reproducible English text and
supervised conversations for smoke tests and an initial data audit.
...
# English-only corpus used by the current model. The earlier multilingual
# examples above are retained as source history but are intentionally replaced
